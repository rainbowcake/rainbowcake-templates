...
- the desired ViewState type for this screen (more info [here](https://gitlab.autsoft.hu/AutSoft/AndroidChapter/android-architecture/android-arch-kotlin#view-states))
